...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: \App\Snippet\Domain\Entity\Snippet::class, orphanRemoval: true)]
    #[Groups(['user:read:full'])]
    private Collection $snippets;

    /**
     * @var Collection<int, \App\Sharing\Domain\Entity\Share>
     */
    #[ORM\OneToMany(mappedBy: 'createdByUser', targetEntity: \App\Sharing\Domain\Entity\Share::class, orphanRemoval: true)]
    private Collection $shares;

    /**
     * @var Collection<int, \App\Attachment\Domain\Entity\Attachment>
     */
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: \App\Attachment\Domain\Entity\Attachment::class, orphanRemoval: true)]
    ...
    public function addSnippet(\App\Snippet\Domain\Entity\Snippet $snippet): static
    {
    ...
    public function removeSnippet(\App\Snippet\Domain\Entity\Snippet $snippet): static
    {
    ...
    /**
     * @return Collection<int, \App\Sharing\Domain\Entity\Share>
     */
    ...
    /**
     * @return Collection<int, \App\Attachment\Domain\Entity\Attachment>
     */
