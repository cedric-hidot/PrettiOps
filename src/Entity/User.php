...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(mappedBy: 'createdByUser', targetEntity: Share::class, orphanRemoval: true)]
    private Collection $shares;

    /**
     * @var Collection<int, Attachment>
     */
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Attachment::class, orphanRemoval: true)]
